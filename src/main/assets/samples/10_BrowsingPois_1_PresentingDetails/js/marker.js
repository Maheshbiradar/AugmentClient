...
function Marker(poiData) {
    ...
    this.markerDrawable_idle = new AR.ImageDrawable(World.markerDrawable_idle, 3.5, {
        zOrder: 0,
        opacity: 1.0,
        /*
    ...
    this.markerDrawable_selected = new AR.ImageDrawable(World.markerDrawable_selected, 3.5, {
        zOrder: 0,
        opacity: 0.0,
        onClick: null
    });
    ...
    this.descriptionLabel = new AR.Label("Rating: " + poiData.rating, 0.8, {
        zOrder: 1,
        translate: {
            y: -0.55
        },

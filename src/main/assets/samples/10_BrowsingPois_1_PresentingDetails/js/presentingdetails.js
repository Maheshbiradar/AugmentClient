...
var World = {
	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
		...
		var singlePoi = {
        				...
        				"icon": poiData.results[currentPlaceNr].icon,
        				"title": poiData.results[currentPlaceNr].name,
        				"description": poiData.results[currentPlaceNr].vicinity,
        				"rating": parseFloat(poiData.results[currentPlaceNr].rating)
        			};
	...
	*/
	...
	//	var serverUrl = ServerInformation.POIDATA_SERVER + "?" + ServerInformation.POIDATA_SERVER_ARG_LAT + "=" + lat + "&" + ServerInformation.POIDATA_SERVER_ARG_LON + "=" + lon + "&" + ServerInformation.POIDATA_SERVER_ARG_NR_POIS + "=20";
	    var serverUrl = "http://winnovarservice20171208095321.azurewebsites.net/api/atm/GetAtms" + "?" + ServerInformation.POIDATA_SERVER_ARG_LAT + "=" + lat + "&" + ServerInformation.POIDATA_SERVER_ARG_LON + "=" + lon;
	    //var serverUrl = "http://winnovarservice20171208095321.azurewebsites.net/api/atm/GetAtms?lat=12.9000&lon=77.5971";

...
var World = {
	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
		...
		var singlePoi = {
        				...
        				"longitude": parseFloat(poiData.results[currentPlaceNr].geometry.location.lon),
	...
	*/
	...
	//	var serverUrl = ServerInformation.POIDATA_SERVER + "?" + ServerInformation.POIDATA_SERVER_ARG_LAT + "=" + lat + "&" + ServerInformation.POIDATA_SERVER_ARG_LON + "=" + lon + "&" + ServerInformation.POIDATA_SERVER_ARG_NR_POIS + "=20";
	    var serverUrl = "http://winnovarservice20171208095321.azurewebsites.net/api/Hospital/GetHospitals" + "?" + ServerInformation.POIDATA_SERVER_ARG_LAT + "=" + lat + "&" + ServerInformation.POIDATA_SERVER_ARG_LON + "=" + lon;

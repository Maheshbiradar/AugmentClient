...
var World = {
	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
		...
		var singlePoi = {
        				...
        				"furnishedstatus": poiData[currentPlaceNr].furnishedstatus,
        				"tenents": poiData[currentPlaceNr].tenents,
        				"amount": parseInt(poiData[currentPlaceNr].amount),
        				"bedrooms": parseInt(poiData[currentPlaceNr].bedrooms),
        				"type": poiData[currentPlaceNr].rating,
        				"rating": parseFloat(poiData[currentPlaceNr].rating)
        			};

            //World.icon = new AR.ImageResource(singlePoi.icon);
	...
	*/
	...
	onMarkerSelected: function onMarkerSelectedFn(marker) {
		...
		*/
		...
		$("#poi-detail-furnishedstatus").html(marker.poiData.furnishedstatus);
		$("#poi-detail-tenents").html(marker.poiData.tenents);
		$("#poi-detail-amount").html(marker.poiData.amount);
		$("#poi-detail-bedrooms").html(marker.poiData.bedrooms);
	...
	*/
	...
	//	var serverUrl = ServerInformation.POIDATA_SERVER + "?" + ServerInformation.POIDATA_SERVER_ARG_LAT + "=" + lat + "&" + ServerInformation.POIDATA_SERVER_ARG_LON + "=" + lon + "&" + ServerInformation.POIDATA_SERVER_ARG_NR_POIS + "=20";
	  var serverUrl = "http://winnovarservice20171208095321.azurewebsites.net/api/Properties/GetProperties/";

		var jqxhr = $.getJSON(serverUrl, function(data) {
		 //World.updateStatusMessage(data);
